  ...
  return (
    <div className="bg-[#141312] text-[#EDE7DC] pt-24 md:pt-28 pb-24">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <ScrollReveal delay={0.1} className="bg-[#181615] border border-[#2D2825] p-6 mb-16 flex items-start gap-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
          {discounts.map((item, idx) => (
            <ScrollReveal key={item.id} delay={idx * 0.08}>
              <div
                className="bg-[#181615] border border-[#2A2623] p-8 flex flex-col justify-between space-y-6 h-full"
              >
                <div>
        ...
        {/* Booking CTA Banner */}
        <ScrollReveal className="bg-[#181615] border border-[#2A2623] p-8 md:p-12 text-center max-w-3xl mx-auto space-y-6">
