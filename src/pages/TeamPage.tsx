  ...
  return (
    <div className="bg-[#141312] text-[#EDE7DC] pt-24 md:pt-28 pb-24">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          {teamMembers.map((member, idx) => (
            <ScrollReveal key={member.slug} delay={idx * 0.08}>
              <Link
                ...
                className="group bg-[#181615] border border-[#2A2623] hover:border-[#CCA300]/60 p-5 transition-all duration-300 block flex flex-col justify-between h-full"
              >
                <div>
                  {/* Member Portrait */}
        ...
        <ScrollReveal className="mt-24 bg-[#181615] border border-[#2A2623] p-8 md:p-12 text-center max-w-3xl mx-auto space-y-4">
